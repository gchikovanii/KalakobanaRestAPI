    ...
    public class RegisterCommandHandler : IRequestHandler<RegisterCommand, RegisterResult>
    {
        ...
        public async Task<RegisterResult> Handle(RegisterCommand request, CancellationToken cancellationToken)
        {
            ...
            if (userName is not null)
                throw new InvalidOperationException($"User Name '{request.RegistrationData.UserName}' is already taken.");
            ...
            if (!result.Succeeded)
            {
                ...
                throw new OperationCanceledException($"Registration failed: {errors}");
            }
            ...
            return new RegisterResult(token, newUser.Email, role);
        }
    }
}
